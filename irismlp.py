...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
   ...
   """
    ...
    # Function to calculate the success rate of the predictions
    ...
    for idx, vector in enumerate(xs):
        i = numpy.ndarray((1,4), buffer=vector)
    #    i = numpy.ndarray((1,4))
...
# Function to identify miss-classified instances of the iris dataset
   ...
   #     print('prediction11', prediction)
    ...
    successRate=str(float(correct)/len(ys))
   # print('11SuccessRate is: ',successRate)
   # print('y_pred: ',y_pred)
   # print('y_true: ',y_true)


# Function to print the miss-classified instances to a csv file called fileName.csv
